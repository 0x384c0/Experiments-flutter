    ...
    return Row(
      children: [
        ...
        Column(
          ...
          children: [
            Text(owner.displayName, style: const TextStyle(color: Color(0xff3ca4ff), fontSize: 12)),
            Row(
              children: [
                Text(
                  '${owner.reputation}',
                  style: const TextStyle(color: Color(0xff9fa6ad), fontSize: 12, fontWeight: FontWeight.bold),
                ),
                if (owner.badgeCounts != null) ...[
                  ...
                  if (owner.badgeCounts!.silver > 0) ...[
                    ...
                    Container(
                      width: 6,
                      height: 6,
                      decoration: BoxDecoration(color: const Color(0xffb4b8bc), borderRadius: BorderRadius.circular(6)),
                    ),
                    const SizedBox(width: 2),
                    Text(
                  ...
                  if (owner.badgeCounts!.bronze > 0) ...[
                    ...
                    Container(
                      width: 6,
                      height: 6,
                      decoration: BoxDecoration(color: const Color(0xffd1a784), borderRadius: BorderRadius.circular(6)),
                    ),
                    const SizedBox(width: 2),
                    Text(
