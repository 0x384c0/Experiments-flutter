...
class TimeWithSecondsPicker extends StatefulWidget {
  final TimeOfDayWithSeconds initialTime;

  const TimeWithSecondsPicker({super.key, required this.initialTime});

  @override
  State<TimeWithSecondsPicker> createState() => _TimeWithSecondsPickerState();
}

class _TimeWithSecondsPickerState extends State<TimeWithSecondsPicker> {
  late int hour;
  late int minute;
  late int second;
