...
class WebViewScreen extends StatefulWidget {
  ...
  const WebViewScreen({super.key, required this.uri, this.headers, this.onNavigate, this.onStopLoading});
...
class _NavigationControls extends StatelessWidget {
  const _NavigationControls({required this.webViewController, required this.canGoBack, required this.canGoForward});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: <Widget>[
        IconButton(icon: const Icon(Icons.arrow_back_ios), onPressed: canGoBack ? () async => await _goBack() : null),
        IconButton(
