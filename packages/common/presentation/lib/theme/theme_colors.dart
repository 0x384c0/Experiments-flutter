...
class ThemeColors extends ThemeExtension<ThemeColors> {
  ...
  final MaterialColor grey = const MaterialColor(0xFF667085, {
    50: Color(0xFFF9FAFB),
  ...
  final MaterialColor error = const MaterialColor(0xFFB42318, {
    50: Color(0xFFFEF3F2),
  ...
  final MaterialColor success = const MaterialColor(0xFF027A48, {
    50: Color(0xFFECFDF3),
  ...
  final MaterialColor primary = const MaterialColor(0xFF577589, {
    50: Color(0xFFEBF0F4),
